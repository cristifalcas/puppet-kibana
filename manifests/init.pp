...
#                                 Default: "0.0.0.0"
#
# $server_basePath::              nables you to specify a path to mount Kibana at if you are running behind a proxy.
#                                 This setting cannot end in a slash (/).
#                                 Default: ''
#
# $server_maxPayloadBytes::       The maximum payload size in bytes for incoming server requests.
#                                 Default: 1048576
#
...
#                                 Default: true
#
# $elasticsearch_pingTimeout::    Time in milliseconds to wait for Elasticsearch to respond to pings.
#                                 Default: the value of the elasticsearch.requestTimeout setting
#
# $elasticsearch_requestTimeout:: Time in milliseconds to wait for responses from the back end or Elasticsearch. This value must be
#                                 a positive integer.
#                                 Default: 300000
#
# $elasticsearch_shardTimeout::   Time in milliseconds for Elasticsearch to wait for responses from shards. Set to 0 to disable.
#                                 Default: 0
#
# $elasticsearch_startupTimeout:: Time in milliseconds to wait for Elasticsearch at Kibana startup before retrying.
#                                 Default: 5000
#
...
class kibana (
  ...
  $server_basePath              = $kibana::params::server_basePath,
  $server_maxPayloadBytes       = $kibana::params::server_maxPayloadBytes,
  $elasticsearch_url            = $kibana::params::elasticsearch_url,
  $elasticsearch_preserveHost   = $kibana::params::elasticsearch_preserveHost,
  ...
  $elasticsearch_pingTimeout    = $kibana::params::elasticsearch_pingTimeout,
  $elasticsearch_requestTimeout = $kibana::params::elasticsearch_requestTimeout,
  $elasticsearch_shardTimeout   = $kibana::params::elasticsearch_shardTimeout,
  $elasticsearch_startupTimeout = $kibana::params::elasticsearch_startupTimeout,
